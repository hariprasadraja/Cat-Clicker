...
const CIMAGE = "CatImage"
const CDETAILS = "CatDetails"
  //  Model
var model = {
  cats: [{
    id: 0,
...
var view = {
  ...
  render: function(id) {
    this.catImageRender.innerHTML = this.getTemplate(id,CIMAGE);
    this.catDetailsRender.innerHTML = this.getTemplate(id, CDETAILS);
  }
}
